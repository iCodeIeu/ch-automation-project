...
testWithReservation.describe('Reservation Management: End-to-End Success', () => {
  testWithReservation.describe('Reservation Management: Standard Full Booking Process', () => {
    ...
    testWithReservation('Should display reservation confirmation with correct details', async ({ reservation, baseURL }) => {
